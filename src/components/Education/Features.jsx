...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "As the Individual Certificate is issued, assignments of Certificate shall be allowed based on written instruction from the participant.",
    },
    {
      image: disc1,
      title: "Profit Sharing",
      description: "Any investment profit from the Takaful Fund will be credited to your Participants Investment Account (PIA) and Participants Risk Fund (PRF) after deducting a 10% profit share, though the Company may choose to deduct less at its discretion.",
    },
    {
      image: Receipt,
      title: "Receipts",
      description: "It is important for you to receive receipts and keep them as proof of payment of Takaful Installments",
    },
    {
      image: Period,
  ...
  return (
    <div className="py-16 bg-amber-50">
      <div className="container mx-auto px-4">
        ...
        Understanding the key terms and conditions of the Alwafa Endowment Plan is essential for your protection and peace of mind. Here are the crucial points to consider.              </p>
        </div>
