...
export const Protocaro = () => {
  return (
    ...
    <div className='flex lg:flex-row flex-col  gap-4 items-start justify-between '>
                ...
                <div>
                <p className='font-[400] text-[18px] text-[#684B06] '>31st March 2023</p>
                <b className='font-[700] text-[24px] text-[#212121] '>Great Service</b>
                <p className='font-[400] text-[18px] text-[#4E4E4E] '>
                ...
                <p>&#11088; &#11088; &#11088; &#11088; &#11088;</p>
                <b className='font-[700] text-[18px] text-[#212121] '>Monalisa , 21</b>
                <p className='font-[500] text-[18px] text-[#8E8E8E] '>Medical Doctor</p>
                </div>
    </div>
    </>
  )
