...
import First from "../assets/5Image.png";
import Second from "../assets/7Image.png";
import Third from "../assets/thirdImage.png";
import Forth from "../assets/8Image.png";
    ...
    <>
      <section className="flex flex-col lg:flex-row bg-[#501720] lg:p-[40px_80px] py-[28px] px-10 gap-[50px]">
        ...
        <div className="lg:w-1/2 hidden lg:grid grid-cols-2 gap-7">
          <img className="relative" src={First} alt="Takaful insurance illustration 1" />
          <img src={Third} alt="Takaful insurance illustration 2" />
          <img
            className="relative lg:-top-[103px] -top-[90px] -mb-[118px]"
            src={Second}
            alt="Takaful insurance illustration 3"
          />
          <img src={Forth} alt="Takaful insurance illustration 4" />
        </div>
      </section>
    </>
  );
