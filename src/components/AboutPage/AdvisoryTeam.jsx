...
const AdvisoryTeam = () => {
  ...
  Guided by Expertise: Our Advisory Team
</h1>

          <p className="text-sm md:text-base lg:text-lg my-4 md:py-[20px] lg:py-[20px] ">
           Bringing deep industry knowledge and strategic insight, our advisory team ensures Alwafa Takaful remains a leader in Sharia-compliant insurance solutions.
          </p>
  ...
  {/* Categories Section */}
    ...
    <h2 className=' w-full text-center lg:text-[44px]'>Advisory Team</h2>
