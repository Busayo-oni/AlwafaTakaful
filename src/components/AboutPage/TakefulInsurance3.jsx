...
import hero1 from '../../assets/pigs.png'
    ...
    <div className="bg-white pt-8 px-4 md:px-16 lg:pt-0">
      <div className="text-center md:text-start lg:text-left grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          Key Features of the Alwafa Credit Takaful Plan
          </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg shadow-sm hover:shadow-md transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
              ...
              Pay your contributions annually or in a lump-sum, offering flexibility.              </p>
            </div>
            ...
            <div className="p-4 border rounded-lg shadow-sm hover:shadow-md transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
              ...
              <p className="text-sm text-gray-500">
              The outstanding financing amount is fully covered at the time of the participant's death.              </p>
            </div>
            <div className="p-4 border rounded-lg shadow-sm hover:shadow-md transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
              <div className=" bg-[rgba(243,194,130,1)] text-white w-10 h-10 rounded-full flex items-center justify-center text-2xl font-bold mb-2">
              ...
              <p className="text-sm text-gray-500 ">
              The Takaful Contribution you pay is based on the financing amount and factors like your age, financing term, and profit rate. Contributions are tailored to fit your financial situation.              </p>
            </div>
          </div>
        </div>
